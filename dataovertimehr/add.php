...
<body>
    <a href="tambahdata.php" class="btn btn-sm btn-info">Go to Home</a>
    <br/><br/>
    ...
    <form action="add.php" method="post" name="form1">
        <table border="0">
            ...
            <tr> 
                <td></td>
                <td><input class="btn btn-sm btn-info" style="margin-left:1000px;" type="submit" name="Submit" value="Add"></td>
            </tr>
        </table>
    </form>
